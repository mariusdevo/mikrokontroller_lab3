...
Først LED-matrisen konfigureres og lysene skrus av. Dere trenger ikke å konfigurere LED-pins som output, siden \verb|GPIOTE|-modulen vil ta hånd om dette for dere. På samme måte slipper dere å konfigurere \verb|BUTTON 1| som input, men annen konfigurasjon som pull-ups må fremdeles konfigureres. 
